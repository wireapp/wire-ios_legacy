...
final class AppLockPresenterTests: XCTestCase {
    ...
    override func setUp() {
        ...
        AppLock.rules = AppLockRules(useBiometricsOrAccountPassword: true, useCustomCodeInsteadOfAccountPassword: false, forceAppLock: false, appLockTimeout: 1) ///TODO: test for useCustomCodeInsteadOfAccountPassword = true
    }
