...
extension MessageDeletedCellTests {
    ...
    func configure(cell: MessageDeletedCell) {
        ...
        let size = cell.systemLayoutSizeFitting(CGSize(width: 375, height: 0), withHorizontalFittingPriority: .required, verticalFittingPriority: UILayoutPriorityFittingSizeLevel)
