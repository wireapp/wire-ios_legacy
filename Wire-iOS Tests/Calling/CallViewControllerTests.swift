...
final class CallViewControllerTests: XCTestCase {
    ...
    private func createCallViewController(selfUser: UserType,
        ...
        let callController = CallViewController(voiceChannel: mockVoiceChannel, selfUser: selfUser, proximityMonitorManager: proximityManager, mediaManager: mediaManager.asEquatable())
