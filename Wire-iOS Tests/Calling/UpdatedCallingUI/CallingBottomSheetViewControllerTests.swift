...
final class CallingBottomSheetViewControllerTests: XCTestCase {
...
//        sut = createCallViewController(selfUser: MockUser.mockSelf(), mediaManager: ZMMockAVSMediaManager())
    ...
    private func createCallingBottomSheetViewController(selfUser: UserType,
                                          mediaManager: ZMMockAVSMediaManager) -> CallingBottomSheetViewController {
...
//        callingBottomSheetController.visibleVoiceChannelViewController.mediaManager = mediaManager
    ...
    func testThatCallGridViewControllerDelegate_ForwardsVideoStreamsRequestToVoiceChannel() {
        ...
        // When
        sut.visibleVoiceChannelViewController.callGridViewController(viewController, perform: .requestVideoStreamsForClients(clients))
