...
class CallingActionsViewSnapshotTests: ZMSnapshotTestCase {
    ...
    private func createSut() {
        ...
        sut.frame = CGRect(origin: .zero, size: CGSize(width: 382, height: 128))
    }
    ...
    func testCallActionsView_StateIncoming_Audio() {
        // Given
        createSut()
        sut.frame = CGRect(origin: .zero, size: CGSize(width: 382, height: 256))
    ...
    func testCallActionsView_StateIncoming_Audio_Landscape() {
        // Given
        createSut()
        sut.frame = CGRect(origin: .zero, size: CGSize(width: 900, height: 128))
        sut.isIncomingCall = true
        sut.viewWillRotate(toPortrait: false)
