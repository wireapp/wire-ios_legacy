...
extension MockUserClient {
    ...
    public func attributedRemoteIdentifier(_ attributes: [NSAttributedStringKey : AnyObject], boldAttributes: [NSAttributedStringKey : AnyObject], uppercase: Bool = false) -> NSAttributedString {
