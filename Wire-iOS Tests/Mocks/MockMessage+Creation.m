...
+ (MockMessage *)linkMessage {
    ...
    Article *article = [[Article alloc] initWithOriginalURLString:@"http://foo.bar/baz" permamentURLString:@"http://foo.bar/baz" resolvedURLString:@"http://foo.bar/baz" offset:0];
