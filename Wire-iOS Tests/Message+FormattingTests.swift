...
class Message_FormattingTests: XCTestCase {
    ...
    func testTextWithTrailingLinkPreviewURL_Giphy() {
        ...
        // when
        let formattedText = NSAttributedString.formattedStringWithLinkAttachments(Message.linkAttachments(textMessageData), forMessage: textMessageData, isGiphy: true)
    ...
    func testTextWithTrailingLinkPreviewURL_Variation1() {
        ...
        // when
        let formattedText = NSAttributedString.formattedStringWithLinkAttachments(Message.linkAttachments(textMessageData), forMessage: textMessageData, isGiphy: false)
