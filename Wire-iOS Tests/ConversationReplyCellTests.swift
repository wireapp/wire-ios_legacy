...
class ConversationReplyCellTests: CoreDataSnapshotTestCase {
    ...
    func testThatItDisplaysLinkPreviewAsText_51() {
        ...
        message.backingTextMessageData?.linkPreview = WireLinkPreview.LinkPreview(originalURLString: url, permanentURLString: url, resolvedURLString: url, offset: 0)
        message.sender = otherUser
        message.conversation = otherUserConversation
    ...
    func testThatItDisplaysLinkPreviewAsText_WithText_51() {
        ...
        message.backingTextMessageData?.linkPreview = WireLinkPreview.LinkPreview(originalURLString: url, permanentURLString: url, resolvedURLString: url, offset: 14)
        message.sender = otherUser
        message.conversation = otherUserConversation
