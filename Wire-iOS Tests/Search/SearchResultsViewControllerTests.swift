...
final class SearchResultsViewControllerTests: XCTestCase {
    ...
    func testThatSearchResultsViewControllerIsNotRetained() {
        autoreleasepool {
            // GIVEN
            var searchResultsViewController: SearchResultsViewController! = SearchResultsViewController(userSelection: UserSelection(), isAddingParticipants: false, shouldIncludeGuests: true, shouldIncludeServices: true, isFederationEnabled: false)
