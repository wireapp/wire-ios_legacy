...
public class WireStyleKit: NSObject {
    ...
    @objc dynamic public class func drawIcon_conversation_emp_64pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
//        //// Bezier Drawing
//        let bezierPath = UIBezierPath()
//        bezierPath.move(to: CGPoint(x: 4.42, y: 0.22))
//        bezierPath.addLine(to: CGPoint(x: 1.33, y: 0.22))
//        bezierPath.addCurve(to: CGPoint(x: 0.33, y: 1.22), controlPoint1: CGPoint(x: 0.78, y: 0.22), controlPoint2: CGPoint(x: 0.33, y: 0.67))
//        bezierPath.addLine(to: CGPoint(x: 0.33, y: 10.22))
//        bezierPath.addCurve(to: CGPoint(x: 2.33, y: 12.22), controlPoint1: CGPoint(x: 0.33, y: 11.33), controlPoint2: CGPoint(x: 1.23, y: 12.22))
//        bezierPath.addLine(to: CGPoint(x: 11.67, y: 12.22))
//        bezierPath.addCurve(to: CGPoint(x: 13.67, y: 10.22), controlPoint1: CGPoint(x: 12.77, y: 12.22), controlPoint2: CGPoint(x: 13.67, y: 11.33))
//        bezierPath.addLine(to: CGPoint(x: 13.67, y: 4.44))
//        bezierPath.addCurve(to: CGPoint(x: 11.67, y: 2.44), controlPoint1: CGPoint(x: 13.67, y: 3.34), controlPoint2: CGPoint(x: 12.77, y: 2.44))
//        bezierPath.addLine(to: CGPoint(x: 7.81, y: 2.44))
//        bezierPath.addCurve(to: CGPoint(x: 7.17, y: 2.21), controlPoint1: CGPoint(x: 7.57, y: 2.44), controlPoint2: CGPoint(x: 7.35, y: 2.36))
//        bezierPath.addLine(to: CGPoint(x: 5.06, y: 0.45))
//        bezierPath.addCurve(to: CGPoint(x: 4.42, y: 0.22), controlPoint1: CGPoint(x: 4.88, y: 0.3), controlPoint2: CGPoint(x: 4.65, y: 0.22))
//        bezierPath.close()
//        color.setStroke()
...
//        bezier2Path.move(to: CGPoint(x: 8.51, y: 0.04))
//        bezier2Path.addLine(to: CGPoint(x: 12.6, y: 0.04))
//        color.setStroke()
//        bezier2Path.lineWidth = 1.25
//        bezier2Path.miterLimit = 4
//        bezier2Path.lineCapStyle = .round
//        bezier2Path.stroke()

//        let bezierPath = UIBezierPath()
//        bezierPath.move(to: CGPoint(x: 14.09, y: 1.12))
//        bezierPath.addLine(to: CGPoint(x: 3.91, y: 1.12))
//        bezierPath.addCurve(to: CGPoint(x: 1.12, y: 3.91), controlPoint1: CGPoint(x: 2.37, y: 1.12), controlPoint2: CGPoint(x: 1.12, y: 2.37))
//        bezierPath.addLine(to: CGPoint(x: 1.12, y: 10.24))
//        bezierPath.addCurve(to: CGPoint(x: 3.91, y: 13.02), controlPoint1: CGPoint(x: 1.12, y: 11.77), controlPoint2: CGPoint(x: 2.37, y: 13.02))
//        bezierPath.addLine(to: CGPoint(x: 4.76, y: 13.02))
//        bezierPath.addLine(to: CGPoint(x: 4.76, y: 16.85))
//        bezierPath.addCurve(to: CGPoint(x: 5.21, y: 17.07), controlPoint1: CGPoint(x: 4.76, y: 17.09), controlPoint2: CGPoint(x: 5.03, y: 17.22))
//        bezierPath.addLine(to: CGPoint(x: 10.21, y: 13.02))
//        bezierPath.addLine(to: CGPoint(x: 14.09, y: 13.02))
//        bezierPath.addCurve(to: CGPoint(x: 16.88, y: 10.24), controlPoint1: CGPoint(x: 15.63, y: 13.02), controlPoint2: CGPoint(x: 16.88, y: 11.77))
//        bezierPath.addLine(to: CGPoint(x: 16.88, y: 3.91))
//        bezierPath.addCurve(to: CGPoint(x: 14.09, y: 1.12), controlPoint1: CGPoint(x: 16.88, y: 2.37), controlPoint2: CGPoint(x: 15.63, y: 1.12))
//        bezierPath.close()
//        color.setStroke()
//        bezierPath.lineWidth = 1.25
//        bezierPath.miterLimit = 4
...
//        //// Bezier 2 Drawing
//        let bezier2Path = UIBezierPath()
//        bezier2Path.move(to: CGPoint(x: 4, y: 5.56))
//        bezier2Path.addLine(to: CGPoint(x: 14, y: 5.56))
//        color.setStroke()
//        bezier2Path.lineWidth = 1.25
//        bezier2Path.miterLimit = 4
//        bezier2Path.lineCapStyle = .round
...
//        bezier3Path.move(to: CGPoint(x: 4, y: 8.94))
//        bezier3Path.addLine(to: CGPoint(x: 9.5, y: 8.94))
//        color.setStroke()
//        bezier3Path.lineWidth = 1.25
...
//        bezier3Path.stroke()
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 20.03, y: 5.56))
        bezierPath.addLine(to: CGPoint(x: 9.84, y: 5.56))
        bezierPath.addCurve(to: CGPoint(x: 7.06, y: 8.34), controlPoint1: CGPoint(x: 8.31, y: 5.56), controlPoint2: CGPoint(x: 7.06, y: 6.81))
        bezierPath.addLine(to: CGPoint(x: 7.06, y: 14.68))
        bezierPath.addCurve(to: CGPoint(x: 9.84, y: 17.46), controlPoint1: CGPoint(x: 7.06, y: 16.21), controlPoint2: CGPoint(x: 8.31, y: 17.46))
        bezierPath.addLine(to: CGPoint(x: 10.7, y: 17.46))
        bezierPath.addLine(to: CGPoint(x: 10.7, y: 21.29))
        bezierPath.addCurve(to: CGPoint(x: 11.15, y: 21.51), controlPoint1: CGPoint(x: 10.7, y: 21.53), controlPoint2: CGPoint(x: 10.97, y: 21.66))
        bezierPath.addLine(to: CGPoint(x: 16.15, y: 17.46))
        bezierPath.addLine(to: CGPoint(x: 20.03, y: 17.46))
        bezierPath.addCurve(to: CGPoint(x: 22.81, y: 14.68), controlPoint1: CGPoint(x: 21.57, y: 17.46), controlPoint2: CGPoint(x: 22.81, y: 16.21))
        bezierPath.addLine(to: CGPoint(x: 22.81, y: 8.34))
        bezierPath.addCurve(to: CGPoint(x: 20.03, y: 5.56), controlPoint1: CGPoint(x: 22.81, y: 6.81), controlPoint2: CGPoint(x: 21.57, y: 5.56))
        bezierPath.close()
       ...
       // bezierPath.miterLimit = 4
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 9.94, y: 10))
        bezier2Path.addLine(to: CGPoint(x: 19.94, y: 10))
        color.setStroke()
        bezier2Path.lineWidth = 1.25
        //bezier2Path.miterLimit = 4
        bezier2Path.lineCapStyle = .round
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 10.94, y: 14.38))
        bezier3Path.addLine(to: CGPoint(x: 16.44, y: 14.38))
        color.setStroke()
        bezier3Path.lineWidth = 1.25
       // bezier3Path.miterLimit = 4
        bezier3Path.lineCapStyle = .round
