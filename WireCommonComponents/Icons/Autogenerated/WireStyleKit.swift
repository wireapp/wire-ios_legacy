...
//  Wire for iOS
//
//  Created by Wire Design Team on 07.07.21.
...
public class WireStyleKit : NSObject {
    ...
    @objc dynamic public class func drawIcon_videoOff_64pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
