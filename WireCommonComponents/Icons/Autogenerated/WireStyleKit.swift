...
public class WireStyleKit : NSObject {
    ...
    @objc dynamic public class func drawExternalUser() {
        // This code was generated by Trial version of PaintCode, therefore cannot be used for commercial purposes.
        // http://www.paintcodeapp.com
        
        //// Color Declarations
        let fillColor = UIColor(red: 0.200, green: 0.216, blue: 0.227, alpha: 1.000)
    ...
    @objc dynamic public class var imageOfExternalUser: UIImage {
        if Cache.imageOfExternalUser != nil {
            return Cache.imageOfExternalUser!
        }
        
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 16, height: 16), false, 0)
        WireStyleKit.drawExternalUser()
        
        Cache.imageOfExternalUser = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
