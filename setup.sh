...
swift run --package-path Scripts/updateStylekit update_stylekit \
    WireCommonComponents/Icons/Autogenerated/WireStyleKit.swift \
    WireCommonComponents/Icons/Autogenerated/StyleKitIcons.generated.swift
echo ""

echo "ℹ️  Update Licenses File..."
swift run --package-path ./Scripts/updateLicenses update_licenses Cartfile.resolved Carthage/Checkouts EmbeddedDependencies.plist Wire-iOS/Resources/Licenses.generated.plist
echo ""
