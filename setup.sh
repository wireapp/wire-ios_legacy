...
export SCRIPT_INPUT_FILE_0=WireCommonComponents/Icons/Autogenerated/WireStyleKit.swift
export SCRIPT_INPUT_FILE_1=Scripts/update_stylekit/

export SCRIPT_OUTPUT_FILE_0=WireCommonComponents/Icons/Autogenerated/StyleKitIcons.generated.swift

swift run --package-path Scripts/update_stylekit/
echo ""
