...
public extension UIAlertController {
    ...
    static func presentProfilePicturePicker() {
        ...
        actionSheet.addAction(UIAlertAction(title: Alert.takePicture, style: .default, handler: { (_) in
//            self.takePhotoAction()
        }))
        actionSheet.addAction(.cancel())

        topmostViewController?.present(actionSheet, animated: true)
    }
...
//extension UIAlertController: UIImagePickerControllerDelegate {
//}
...
class ImagePickerManager: NSObject {
    ...
    func showActionSheet(vc: UIViewController,
        ...
        // Take Photo
        let photoAction = UIAlertAction(title: Alert.takePicture, style: .default) { action -> Void in
