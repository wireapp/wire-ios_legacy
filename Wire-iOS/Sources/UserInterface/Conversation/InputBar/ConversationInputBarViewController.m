...
- (void)updateAvailabilityPlaceholder
{
    ...
    if (connectedUserAvailability == AvailabilityNone) {
        ...
        self.inputBar.availabilityPlaceholder = [UILabel composeStringTextWithAvailability:connectedUserAvailability
                                                                                     color:_inputBar.placeholderColor
                                                                                     style:AvailabilityStylePlaceholder
                                                                               interactive:NO
                                                                                     title:self.conversation.connectedUser.displayName];
    }
