...
final class BackupPasswordViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        let attributes: [NSAttributedString.Key: Any] = [.foregroundColor: SemanticColors.Label.textInputViewPlaceholder,
    ...
    private func setupNavigationBar() {
        ...
        let navigationBarColor = SemanticColors.Label.textDefault
