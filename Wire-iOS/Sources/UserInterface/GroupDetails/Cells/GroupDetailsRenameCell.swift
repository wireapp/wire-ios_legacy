...
class GroupDetailsRenameCell : UICollectionViewCell, Restricted {
    ...
    fileprivate func setup() {
        ...
        accessoryIconView.image = UIImage(icon: .pencil, size: 12, color: UIColor.from(scheme: .textForeground, variant: variant))
    ...
    private func configureColors() {
        ...
        accessoryIconView.image = UIImage(icon: .pencil, size: .tiny, color: UIColor.from(scheme: .textForeground, variant: variant))
