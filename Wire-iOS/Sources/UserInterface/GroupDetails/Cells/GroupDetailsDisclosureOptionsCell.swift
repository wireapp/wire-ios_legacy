...
class DisclosureCell: RightIconDetailsCell {
    override func applyColorScheme(_ colorSchemeVariant: ColorSchemeVariant) {
        ...
        let disclosureIndicatorColor = SemanticColors.foregroundChevronCellActive
        accessory = StyleKitIcon.disclosureIndicator.makeImage(size: 12, color: disclosureIndicatorColor)
    }
}
