...
@objcMembers class DefaultNavigationBar : UINavigationBar {
    ...
    func configure() {
        ...
        backIndicatorImage = UIImage(icon: .backArrow, size: .tiny, color: UIColor.from(scheme: .textForeground, variant: colorSchemeVariant)).withInsets(backIndicatorInsets, backgroundColor: .clear)
        backIndicatorTransitionMaskImage = UIImage(icon: .backArrow, size: .tiny, color: .black).withInsets(backIndicatorInsets, backgroundColor: .clear)
    }
