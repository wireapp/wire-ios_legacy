...
public class GuestIndicator: UIImageView, Themeable {
    ...
    func applyColorScheme(_ colorSchemeVariant: ColorSchemeVariant) {
        image = UIImage(icon: .guest, size: .tiny, color: UIColor.from(scheme: .iconGuest, variant: colorSchemeVariant))
    }
...
public class GuestLabelIndicator: UIStackView, Themeable {
    ...
    func applyColorScheme(_ colorSchemeVariant: ColorSchemeVariant) {
        ...
        guestIcon.image = UIImage(icon: .guest, size: .tiny, color: UIColor.from(scheme: .textForeground, variant: colorSchemeVariant))
    }
