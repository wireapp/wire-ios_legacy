...
final class TextSearchInputView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        clearButton.setIconColor(SemanticColors.Icon.clearButton, for: .normal)
    ...
    private func createConstraints() {
        ...
        NSLayoutConstraint.activate(
            ...
            clearButton.trailingAnchor.constraint(equalTo: searchInput.trailingAnchor, constant: -8),
