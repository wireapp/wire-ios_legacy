...
final class PhoneNumberFieldDescription: NSObject, ValueSubmission {
...
extension PhoneNumberFieldDescription: ViewDescriptor {
    func create() -> UIView {
...
extension PhoneNumberFieldDescription: UITextFieldDelegate {
...
extension PhoneNumberFieldDescription: TextFieldValidationDelegate {
