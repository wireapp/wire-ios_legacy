...
extension UIColor {
    ...
    private static let accentColorNameColorBlendingCoefficientsDark: [CGFloat] = [0.8, 0.72, 0.0, 1.0, 0.8, 0.8, 0.8, 0.64]
    private static let accentColorNameColorBlendingCoefficientsLight: [CGFloat] = [0.8, 0.72, 0.0, 1.0, 0.8, 0.8, 0.64, 1.0]
