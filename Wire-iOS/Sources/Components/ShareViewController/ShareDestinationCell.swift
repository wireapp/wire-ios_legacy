...
final class ShareDestinationCell<D: ShareDestination>: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.guestUserIcon = UIImageView(image: UIImage(icon: .guest, size: .tiny, color: UIColor(white: 1.0, alpha: 0.64)))
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        self.checkImageView.image = selected ? UIImage(icon: .checkmark, size: .smallBadge, color: .white) : nil
