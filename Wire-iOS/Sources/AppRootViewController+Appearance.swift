...
extension AppRootViewController {
    ...
    public static func configureAppearance() {
        ...
        let attributes: [NSAttributedStringKey : Any] = [.font: UIFont.systemFont(ofSize: 11, weight: UIFont.Weight.semibold), baselineOffset.rawValue: navigationBarTitleBaselineOffset]
