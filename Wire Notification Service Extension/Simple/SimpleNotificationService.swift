    ...
    override func didReceive(
        ...
        let task = Task { [weak self] in
            do {
                ...
                let messageExtractor = EventMessageExtractor(managedObjectContext: coreDataStack.syncContext)
                let job = try Job(request: request, eventDecoder: eventDecoder, eventMessageExtractor: messageExtractor)
